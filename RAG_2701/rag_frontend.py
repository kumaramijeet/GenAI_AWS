...
new_title = '<p style="font-family:sans-serif; color:Green; font-size: 42px;">HR Q and A with RAG 🎯</p>'
...
go_button = st.button("📍 Learn GenAI with Amijeet", type="primary")


if go_button:
    with st.spinner("🔉 Anytime someone tells me I cant do something, I want to do it more - Taylor Swift"):
